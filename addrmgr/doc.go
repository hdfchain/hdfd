...
/*
Package addrmgr implements concurrency safe Hdfchain address manager.

Address Manager Overview

In order maintain the peer-to-peer Hdfchain network, there needs to be a source
of addresses to connect to as nodes come and go.  The Hdfchain protocol provides
