...
var (
	...
	// mainPowLimit is the highest proof of work value a Hdfchain block can
	...
	// simNetPowLimit is the highest proof of work value a Hdfchain block
...
// MainNetParams defines the network parameters for the main Hdfchain network.
var MainNetParams = Params{
	Name:        "mainnet",
	Net:         wire.MainNet,
	DefaultPort: "9108",
	DNSSeeds: []string{
		"mainnet-seed.hdfchain.clkj.ltd",
		"mcshop.qinmaoyi.cn",
		"mainnet.clkj.ltd",
		"mainnet-seed.clkj.ltd",
	},
...
var TestNet2Params = Params{
	...
	DefaultPort: "19108",
	DNSSeeds: []string{
		"testnet-seed.hdfchain.clkj.ltd",
		"testnet-seed.qinmaoyi.cn",
		"testnet.clkj.ltd",
		"testnet-seed.clkj.ltd",
	},
...
// SimNetParams defines the network parameters for the simulation test Hdfchain
...
var (
	// ErrDuplicateNet describes an error where the parameters for a Hdfchain
	// network could not be set due to the network already being a standard
	// network or previously-registered into this package.
	ErrDuplicateNet = errors.New("duplicate Hdfchain network")
...
// Register registers the network parameters for a Hdfchain network.  This may
