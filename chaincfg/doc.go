...
//
// In addition to the main Hdfchain network, which is intended for the transfer
...
// wire.HdfchainNet using ParamsForNet, but be aware that this usage is
...
//  }
//
// If an application does not use one of the standard Hdfchain networks, a new
