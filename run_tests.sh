...
DOCKER_IMAGE_TAG=hdfchain-golang-builder-$GOVERSION

docker pull hdfchain/$DOCKER_IMAGE_TAG

docker run --rm -it -v $(pwd):/src hdfchain/$DOCKER_IMAGE_TAG /bin/bash -c "\
