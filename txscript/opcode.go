...
import (
	...
	"github.com/hdfchain/hdfd/dcrec/edwards/v2"
	"github.com/hdfchain/hdfd/dcrec/secp256k1/v2"
	"github.com/hdfchain/hdfd/dcrec/secp256k1/v2/schnorr"
...
const (
	...
	OP_NOP9                = 0xb8 // 184
	OP_NOP10               = 0xb9 // 185
	OP_SSTX                = 0xba // 186 HDFCHAIN
	OP_SSGEN               = 0xbb // 187 HDFCHAIN
	OP_SSRTX               = 0xbc // 188 HDFCHAIN
	OP_SSTXCHANGE          = 0xbd // 189 HDFCHAIN
	OP_CHECKSIGALT         = 0xbe // 190 HDFCHAIN
	OP_CHECKSIGALTVERIFY   = 0xbf // 191 HDFCHAIN
	OP_SHA256              = 0xc0 // 192
