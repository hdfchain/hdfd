...
A Block defines a Hdfchain block that provides easier and more efficient
...
A Tx defines a Hdfchain transaction that provides more efficient manipulation of
...
The Address interface provides an abstraction for a Hdfchain address.  While the
most common type is a pay-to-pubkey-hash, Hdfchain already supports others and
