...
// for hdfd and other utilities provided in the same repository.
package version
...
var (
	...
	// build process with:
	// '-ldflags "-X github.com/hdfchain/hdfd/internal/version.PreRelease=foo"'
	...
	// build process with:
	// '-ldflags "-X github.com/hdfchain/hdfd/internal/version.BuildMetadata=foo"'
