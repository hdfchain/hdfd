...
/*
Package secp256k1 implements support for the elliptic curves needed for Hdfchain.

Hdfchain uses elliptic curve cryptography using koblitz curves
...
standard formats.  It was designed for use with hdfd, but should be
