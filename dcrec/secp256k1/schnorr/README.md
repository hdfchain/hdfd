...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/hdfchain/hdfd/dcrec/secp256k1/v3/schnorr)
...
`EC-Schnorr-HDFv0` that is described herein.  The signatures and implementation
...
| EC-Schnorr-HDFv0 |  d*G   | hash(R.x ∥ m)       | R.x       | k - d*e          |
...
While there are various methods, the choice made for `EC-Schnorr-HDFv0` is to
...
variant is chosen for `EC-Schnorr-HDFv0` as well.
...
`EC-Schnorr-HDFv0` that can be made to further harden security for multi-party
...
## EC-Schnorr-HDFv0 Specification

### EC-Schnorr-HDFv0 Signing Algorithm

The algorithm for producing an EC-Schnorr-HDFv0 signature is as follows:
...
### EC-Schnorr-HDFv0 Verification Algorithm

The algorithm for verifying an EC-Schnorr-HDFv0 signature is as follows:
...
### EC-Schnorr-HDFv0 Signature Serialization Format
...
The EC-Schnorr-HDFv0 scheme is partly based on work that was ongoing in the
...
```bash
$ go get -u github.com/hdfchain/hdfd/dcrec/secp25k1/v3/schnorr
```

## Examples

* [Sign Message](https://pkg.go.dev/github.com/hdfchain/hdfd/dcrec/secp256k1/v3/schnorr#example-package-SignMessage)  
  Demonstrates signing a message with the EC-Schnorr-HDFv0 scheme using a
  secp256k1 private key that is first parsed from raw bytes and serializing the
  generated signature.

* [Verify Signature](https://pkg.go.dev/github.com/hdfchain/hdfd/dcrec/secp256k1/v3/schnorr#example-Signature.Verify)  
  Demonstrates verifying an EC-Schnorr-HDFv0 signature against a public key that
