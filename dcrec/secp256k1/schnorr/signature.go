...
import (
	...
	"github.com/hdfchain/hdfd/dcrec/secp256k1/v3"
)
...
var (
	...
	// the deterministic nonce for the EC-Schnorr-HDFv0 scheme.  This ensures
	// the same nonce is not generated for the same message and key as for other
	// signing algorithms such as ECDSA.
	//
	// It is equal to BLAKE-256([]byte("EC-Schnorr-HDFv0")).
...
// ParseSignature parses a signature according to the EC-Schnorr-HDFv0
...
func schnorrVerify(sig *Signature, hash []byte, pubKey *secp256k1.PublicKey) error {
	// The algorithm for producing a EC-Schnorr-HDFv0 signature is described in
...
// schnorrSign generates an EC-Schnorr-HDFv0 signature over the secp256k1 curve
...
// Sign generates an EC-Schnorr-HDFv0 signature over the secp256k1 curve for the
