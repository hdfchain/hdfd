...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/hdfchain/hdfd/dcrec/secp256k1/v3/ecdsa)
...
```bash
$ go get -u github.com/hdfchain/hdfd/dcrec/secp25k1/v3/ecdsa
```

## Examples

* [Sign Message](https://pkg.go.dev/github.com/hdfchain/hdfd/dcrec/secp256k1/v3/ecdsa#example-package-SignMessage)  
  Demonstrates signing a message with a secp256k1 private key that is first
  parsed from raw bytes and serializing the generated signature.

* [Verify Signature](https://pkg.go.dev/github.com/hdfchain/hdfd/dcrec/secp256k1/v3/ecdsa#example-Signature.Verify)  
