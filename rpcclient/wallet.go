...
func (r FutureListLockUnspentResult) Receive() ([]*wire.OutPoint, error) {
	...
	for i, input := range inputs {
		...
		ops[i] = wire.NewOutPoint(sha, input.Vout, input.Tree) // Hdfchain TODO
	}
...
// Hdfchain address for receiving payments to the specified account.
...
// GetAccountAddress returns the current Hdfchain address for receiving payments
