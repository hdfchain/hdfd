...
; The default is ~/.hdfd/data on POSIX OSes, $LOCALAPPDATA/Dcrd/data on Windows,
; ~/Library/Application Support/Dcrd/data on macOS, and $homed/hdfd/data on
...
// DcrctlSampleConfig is a string containing the commented example config for hdfctl.
