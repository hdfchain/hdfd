...
var (
	...
	dcrctlHomeDir         = dcrutil.AppDataDir("hdfctl", false)
	dcrwalletHomeDir      = dcrutil.AppDataDir("hdfwallet", false)
	defaultConfigFile     = filepath.Join(dcrctlHomeDir, "hdfctl.conf")
