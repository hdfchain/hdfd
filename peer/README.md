...
[![Doc](https://img.shields.io/badge/doc-reference-blue.svg)](https://pkg.go.dev/github.com/hdfchain/hdfd/peer/v2)

Package peer provides a common base for creating and managing Hdfchain network
peers.

This package has intentionally been designed so it can be used as a standalone
package for any projects needing a full featured Hdfchain peer base to build on.
...
```bash
$ go get -u github.com/hdfchain/hdfd/peer
```

## Examples

* [New Outbound Peer Example](https://pkg.go.dev/github.com/hdfchain/hdfd/peer/v2#example-package-NewOutboundPeer)
