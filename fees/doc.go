...
second layer alternatives, etc). Also, the current fill rate of blocks in hdfchain
...
out earlier should be sufficient for current fill rate of hdfchain's network.
