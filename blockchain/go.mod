module github.com/hdfchain/hdfd/blockchain/v3
...
replace (
	github.com/hdfchain/hdfd/blockchain/stake/v3 => ./stake
	github.com/hdfchain/hdfd/blockchain/standalone/v2 => ./standalone
