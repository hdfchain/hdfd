...
require (
	...
	github.com/hdfchain/hdfd/chaincfg v1.2.0
	github.com/hdfchain/hdfd/chaincfg/chainhash v1.0.1
	github.com/hdfchain/hdfd/database v1.0.3
	github.com/hdfchain/hdfd/dcrec v0.0.0-20180801202239-0761de129164
	github.com/hdfchain/hdfd/dcrec/secp256k1 v1.0.1
	github.com/hdfchain/hdfd/dcrutil v1.2.0
	github.com/hdfchain/hdfd/gcs v1.0.1
	github.com/hdfchain/hdfd/txscript v1.0.2
