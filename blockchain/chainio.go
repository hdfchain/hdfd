...
import (
	...
	"github.com/hdfchain/hdfd/blockchain/v2/internal/dbnamespace"
...
// The amount is never encoded into spent transaction outputs in Hdfchain
...
func decodeSpentTxOut(serialized []byte, stxo *spentTxOut, amount int64, height uint32, index uint32) (int, error) {
	...
	// since in Hdfchain we only need pkScript at most due to fraud proofs
