...
// MsgNotFound defines a hdfchain notfound message which is sent in response to
...
// NewMsgNotFound returns a new hdfchain notfound message that conforms to the
