...
// MsgMemPool implements the Message interface and represents a Hdfchain mempool
...
// NewMsgMemPool returns a new Hdfchain pong message that conforms to the Message
