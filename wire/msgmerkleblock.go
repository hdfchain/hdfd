...
// MsgMerkleBlock implements the Message interface and represents a hdfchain
...
// NewMsgMerkleBlock returns a new hdfchain merkleblock message that conforms to
