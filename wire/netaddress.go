...
// maxNetAddressPayload returns the max payload size for a hdfchain NetAddress
...
type NetAddress struct {
	...
	// not present in the hdfchain version message (MsgVersion) nor was it
...
func readNetAddress(r io.Reader, pver uint32, na *NetAddress, ts bool) error {
	...
	// NOTE: The hdfchain protocol uses a uint32 for the timestamp so it will
	...
	// Sigh.  Hdfchain protocol mixes little and big endian.
