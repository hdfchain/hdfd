...
const DefaultUserAgent = "/hdfwire:0.3.0/"
...
// NewMsgVersion returns a new hdfchain version message that conforms to the
...
// and local address from conn and returns a new hdfchain version message that
