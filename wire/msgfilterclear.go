...
// MsgFilterClear implements the Message interface and represents a hdfchain
...
// NewMsgFilterClear returns a new hdfchain filterclear message that conforms to the Message
