...
import "github.com/hdfchain/hdfd/dcrjson/v3"

const (
	// AccountBalanceNtfnMethod is the method used for account balance
	// notifications.
	//
	// Deprecated: hdfwallet does not provide JSON-RPC notifications
	...
	// RevocationCreatedNtfnMethod is the method of the hdfwallet
	// revocationcreated notification.
	//
	// Deprecated: hdfwallet does not provide JSON-RPC notifications
	RevocationCreatedNtfnMethod = "revocationcreated"

	// TicketPurchasedNtfnMethod is the method of the hdfwallet
	// ticketpurchased notification.
	//
	// Deprecated: hdfwallet does not provide JSON-RPC notifications
	TicketPurchasedNtfnMethod = "ticketpurchased"

	// VoteCreatedNtfnMethod is the method of the hdfwallet
